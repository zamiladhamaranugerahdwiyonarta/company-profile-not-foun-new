...
<head>
    ...
    <!-- Favicons -->
    <link href="assets/img/wb/not-found.png" rel="icon">
    <link href="assets/img/wb/not-found.png" rel="apple-touch-icon">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
                    ...
                    <h2 data-aos="fade-up" data-aos-delay="400">Kaosnya anak error, dengan harga yang main-main tetapi
                        tidak dengan kualitas yang main-main.</h2>
                    <div data-aos="fade-up" data-aos-delay="800">
                        <a href="https://s.id/WBproductions" target="_blank" class="btn-get-started scrollto">Beli
                            Sekarang</a>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row content">
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="150">
                        <p> Not FounD adalah sebuah anak usaha dari perusahaan WB productions yang bergerak di bidang
                            clothing. kita memperioritaskan kualitas tetapi dengan harga yang bisa merusak pasar. </p>
                        <ul>
                    ...
                    <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-up" data-aos-delay="300">
                        <p>Kamu bisa menghubungi kita lewat email atau WhatsApp apabila ada yang perlu ditanyakan, atau
                            bahkan bisa langsung ke lokasi kita untuk melihat langsung produksi clothing. </p>
                    </div>
                </div>
                        ...
                        <div class="border-item-kaos">
                            ...
                            <center>
                                ...
                                <ul id="portfolio-beli">
                                    <li class="filter-active"><a href="https://s.id/WBproductions"
                                            target="_blank">Beli</a></li>
                    ...
                    <div class="col-md-4 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                        <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <h5 class="title"><a href="">Proses Cepat</a></h4>
                                <p class="description service-teks">Waktu pemrosesan rata-rata adalah 3 hingga 7 hari
                                </p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                        <div class="contact-about">
                            ...
                            <div class="social-links">
                                <a href="https://www.youtube.com/channel/UCXvIXhB_BfYe2YrlDHMqsNw" target="_blank"
                                    class="youtube"><i class="icofont-youtube"></i></a>
                                <a href="https://www.instagram.com/wb_productions2020/?igshid=r7rkbbmlt30c"
                                    target="_blank" class="instagram"><i class="icofont-instagram"></i></a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row d-flex align-items-center">
                <div class="col-lg-6 text-lg-left text-center">
                    ...
                    <div class="credits">
                        ...
                        Designed by <a href="https://wb-productions.id" target="_blank">WBproductions</a>
                    </div>
                </div>
            </div>
        </div>
