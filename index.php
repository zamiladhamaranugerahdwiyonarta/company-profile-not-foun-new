      ...
      <div class="container">
        ...
        <div class="row content">
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="150">
            <p> Not FounD adalah sebuah anak usaha dari perusahaan WB productions yang bergerak di bidang clothing. kita memperioritaskan kualitas tetapi dengan harga yang bisa merusak pasar.            </p>
            <ul>
          ...
          <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-up" data-aos-delay="300">
            <p>Kamu bisa menghubungi kita lewat email atau WhatsApp apabila ada yang perlu ditanyakan, atau bahkan bisa langsung ke lokasi kita untuk melihat langsung produksi clothing.            </p>
          </div>
        </div>
